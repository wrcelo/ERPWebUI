...
const dados: Empresa[] = [
  {
    id: "1",
    imgUrl:
      "https://www.intermercados.com.br/wp-content/uploads/2018/07/fachada-de-empresa.jpg",
    nome: "Empresa Alpha",
    cnpj: "12345678001",
  ...
  },
  {
    id: "2",
    imgUrl:
      "https://carvalhoprintoffice.com.br/wp-content/uploads/2020/09/revestimento-acm-fachada.jpg",
    nome: "Empresa Beta",
    cnpj: "98765432001",
  ...
  },
  {
    id: "3",
    imgUrl:
      "https://comunicacao.hdvisual.net/imagens/empresa-de-fachada-loja.jpg",
    nome: "Empresa Gamma",
    cnpj: "19283746001",
  ...
  },
  {
    id: "4",
    imgUrl:
      "https://aaxesquadrias.com.br/wp-content/uploads/2021/07/1640f-fachada-pele-de-vidro-3.jpg",
    nome: "Empresa Delta",
    cnpj: "56473829001",
  ...
  },
  {
    id: "5",
    imgUrl:
      "https://static9.depositphotos.com/1279189/1195/i/450/depositphotos_11956071-stock-photo-modern-business-unit.jpg",
...
const Empresas = () => {
  ...
  const handleEdit = (empresa: Empresa) => {
    ...
    if (empresa) {
      ...
      form.setValue(
        "cidade",
        empresa?.endereco?.cidade ? empresa.endereco.cidade : ""
      );
      form.setValue(
        "bairro",
  ...
  const handleBuscaEmpresas = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const filteredData = dados.filter((empresa: any) =>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="col-span-3">
                        ...
                        <FormControl>
                          <Input placeholder="Vitória" {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
